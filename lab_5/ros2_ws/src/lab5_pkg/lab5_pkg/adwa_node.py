...
class DWA_Node(Node):
    def __init__(self):
        ...
        self.optimal_target_dist = 0.3 # best following distance
        self.slowing_distance = 0.8 #distance threshold to slow down
        ...
        #  real robot ## self.create_subscription(LandmarkArray, '/camera/landmarks', self.landmark_callback, 10)
